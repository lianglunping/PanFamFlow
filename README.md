...
**English** | [简体中文](README.zh-CN.md) | [中文交互式教程](docs/index.html) | [58-item coverage audit](docs/ANALYSIS_COVERAGE.zh-CN.md) | [Project site](https://lianglunping.github.io/PanFamFlow/index.html?rev=pages-entry-fix-20260819) | [Online tutorial](https://lianglunping.github.io/PanFamFlow/tutorial/)
...
- **Beginner and scientific tutorial**: a self-contained Chinese HTML guide preserves the 12-step runbook and adds eight scientific chapters covering concepts, rationale, execution, result reading, QC, supported/unsupported conclusions, failure modes, and all 58 audited analysis items.
